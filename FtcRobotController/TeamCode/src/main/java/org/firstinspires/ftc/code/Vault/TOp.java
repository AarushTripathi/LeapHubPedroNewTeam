...
//
//    private Pose pose = new Pose(10.2, 13, Math.toRadians(0));
//    private final Pose spec = new Pose(37.8, 61, Math.toRadians(180));
//
//    public enum States {
...
//                        new Point(pose),
//                        new Point(spec)));
//        hang.setLinearHeadingInterpolation(pose.getHeading(), spec.getHeading());
//
//    }
//
//    }
